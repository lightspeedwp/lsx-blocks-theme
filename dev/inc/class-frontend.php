...
class Frontend {
	...
	public function styles() {
		...
		wp_enqueue_style( 'wprig-fonts', $this->fonts_url(), array(), null ); // phpcs:ignore WordPress.WP.EnqueuedResourceParameters.MissingVersion

		// Enqueue main stylesheet.
		wp_enqueue_style( 'wprig-base-style', get_stylesheet_uri(), array(), '20180514' );

		wp_enqueue_style( 'wprig-bootstrap', get_theme_file_uri( '/css/bootstrap.css' ), array(), '20180514' );
	...
	public function scripts() {
		...
		wp_enqueue_script( 'wprig-bootstrap' );
